function dismoor(command)
    ...
    global z
    global a = mooring(H)
    global eles = mooring(moorele)
    disp(eles)
    disp("HELLO WORLD TESSSSSSSSSSSSSSSSST")
    ...
    for el=1:mm,
        ...
        if isempty(Z),
            hght=z(1,1)-sum(H(1,el:mm));  % Height from the top to the surface of this element pm
