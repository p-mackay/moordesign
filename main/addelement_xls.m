function addelement_xls(command);
    ...
    if nargin < 1, command=0; end
        if isempty(addel), addel=1; end
            if command == 0,  % then initialize the menus/number
                ...
                'Callback','addelement_xls(1)','FontSize',fs,...
                ...
                %	'Callback','addelement_xls(2)','FontSize',fs,...
                %	'String',typelist,...
                %	'Units','Normalized',...
                %	'Position',[.1 .785 .8 .1]);
                ...
                'Units','Normalized',...
                'Position',[.45 .6 .5 .08]);
                %ntoadd=get(h_edit_elename,'String');
                ...
                'Callback','addelement_xls(3)','FontSize',fs,...
            ...
            if command==1 || command==2,
                    ...
                    %		'Units','normalized',...
                    %		'Position',[.05 .1 .2 .08],...
                    %		'Callback','addelement_xls(5)');
                    %elseif addel == 4,
                    %	h_push_add=uicontrol('Style','Pushbutton',...
                    %		'String','Modify','FontSize',fs,...
                    %		'Units','normalized',...
                    %		'Position',[.05 .1 .2 .08],...
                    %		'Callback','addelement_xls(8)');
                endif
            end
