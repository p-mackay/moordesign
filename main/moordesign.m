        ...
        if ss(3) >= 1024, fs=11; end
            if ss(3) > 1200, fs=12; end
                ...
                if isempty(uw), uw=0;vw=0; end
                    %
                    figure(1);figname=get(1,'Name');drawnow;
                    ...
                    'Load Mooring From Excel','FontSize',fs,...
                    'Units','normalized',...
                    'Position',[.05 .68 .44 .08],...
                    'backgroundcolor',xlcolor,...
                    'Callback','spreadsheet_to_mat');
                    hmain22=uicontrol('Style','Pushbutton','String',...
                    'Import Database from Excel','FontSize',fs,...
                    'Units','normalized',...
                    'Position',[.51 .68 .44 .08],...
                    'backgroundcolor',xlcolor,...
                    'Callback','importdb');
                    hmain23=uicontrol('Style','Pushbutton','String',...
                    'Export Database to Excel','FontSize',fs,...
                    'Units','normalized',...
                    ...
                    if ~isempty(U) && ~isempty(z),
                        ...
                        hmain5=uicontrol('Style','Pushbutton','String',... %main screen
                        'Set/Load Envir. Cond.','FontSize',fs,...
                        'Units','normalized',...
                        'Position',[.1 .21 .8 .08],...
                        'backgroundcolor',bgcolor,...
                    ...
                    if (~isempty(H) && ~isempty(moorele))||(~isempty(Ht) && ~isempty(moorelet)), % once a moorings loaded
                        ...
                        if ~isempty(Z),
                            ...
                            'String','Mooring Summary','FontSize',fs,...
                            'Units','normalized',...
                            'Position',[.05 .32 .325 .08],...
                            'backgroundcolor',bgcolor,...
                            'Callback','dismoor(1)');
                            hmain9=uicontrol('Style','Pushbutton',...
                            'String','Tally','FontSize',fs,...
                            'Units','normalized',...
                            'Position',[.375 .32 .22 .08],...
                            'backgroundcolor',bgcolor,...
                            'Callback','dismoor(0)');
                        else
                            hmain8=uicontrol('Style','Pushbutton',...
                            ...
                            'Callback','dismoor(1)');
                            hmain9=uicontrol('Style','Pushbutton',...
                            'String',"Tally Elements",'FontSize',fs,...
                            'Units','normalized',...
                            'Position',[.375 .32 .22 .08],...
                            'backgroundcolor',bgcolor,...
                            'Callback','dismoor(0)');
